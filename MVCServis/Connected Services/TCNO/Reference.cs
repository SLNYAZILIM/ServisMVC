...
namespace MVCServis.TCNO {
    ...
    public interface KPSPublicSoap {
        ...
        MVCServis.TCNO.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(MVCServis.TCNO.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<MVCServis.TCNO.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MVCServis.TCNO.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public MVCServis.TCNO.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(MVCServis.TCNO.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public MVCServis.TCNO.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(MVCServis.TCNO.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : MVCServis.TCNO.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MVCServis.TCNO.KPSPublicSoap>, MVCServis.TCNO.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MVCServis.TCNO.TCKimlikNoDogrulaResponse MVCServis.TCNO.KPSPublicSoap.TCKimlikNoDogrula(MVCServis.TCNO.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            MVCServis.TCNO.TCKimlikNoDogrulaRequest inValue = new MVCServis.TCNO.TCKimlikNoDogrulaRequest();
            inValue.Body = new MVCServis.TCNO.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            MVCServis.TCNO.TCKimlikNoDogrulaResponse retVal = ((MVCServis.TCNO.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MVCServis.TCNO.TCKimlikNoDogrulaResponse> MVCServis.TCNO.KPSPublicSoap.TCKimlikNoDogrulaAsync(MVCServis.TCNO.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MVCServis.TCNO.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            MVCServis.TCNO.TCKimlikNoDogrulaRequest inValue = new MVCServis.TCNO.TCKimlikNoDogrulaRequest();
            inValue.Body = new MVCServis.TCNO.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MVCServis.TCNO.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
